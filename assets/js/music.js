...
var tips = [
    ...
    "If you spot any bugs, Please let me know at brittcgresham@gmail.com",
    "Techno and Rap songs work the best",
    "Version " + versionString,
    "To end the game press Escape at any time.",
    "Resting your fingers on the keys instead of \"Hovering\" above them will help with timing",
    "Special Thanks to The Former! Check them Out",
    "Flashing notes give an extra bonus if you keep your Combo"
];

function init() {
    console.log('/--------------------------\\');
    console.log('|  Music Music Revolution  |');
    console.log('| Created By Britt Gresham |');
    console.log('\\--------------------------/');
